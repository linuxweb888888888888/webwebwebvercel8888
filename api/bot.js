...
app.get('/', (req, res) => {
    res.send([
        ...
        '                                <div style="flex:1;"><label class="text-danger" style="margin-top:0;">Global Single Coin SL PNL ($)</label><input type="number" step="0.0001" id="globalSingleCoinSlPnl" placeholder="e.g. -5.00 (0 = Profile Level)"></div>',
        ...
        '                    let dynamicInfoHtml2 = \'<div class="stat-box" style="margin-bottom:16px; background:#E3F2FD; border-color:#90CAF9; color:var(--'
