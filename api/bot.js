...
app.get('/', (req, res) => {
    res.send([
        ...
        '            if (tab === \'main\') { document.getElementById(\'main-tab\').style.display = \'block\'; document.getElementById(\'btn-tab-main\').classList.add(\'active\'); } ',
        '            else if (tab === \'offsets\') { document.getElementById(\'offset-tab\').style.display = \'block\'; document.getElementById(\'btn-tab-offsets\').classList.add(\'active\'); loadOffsets(); } ',
        '            else if (tab === \'offsets2\') { document.getElementById(\'offset2-tab\').style.display = \'block\'; document.getElementById(\'btn-tab-offsets2\').classList.add(\'active\'); loadOffsets(); } ',
        '            else if (tab === \'admin\') { document.getElementById(\'admin-tab\').style.display = \'block\'; document.getElementById(\'btn-tab-admin\').classList.add(\'active\'); loadAdminData(); } ',
        '            else if (tab === \'editor\') { document.getElementById(\'editor-tab\').style.display = \'block\'; document.getElementById(\'btn-tab-editor\').classList.add(\'active\'); loadMasterEditor(); }',
        '        }',
        ...
        '                globalSingleCoinSlPnl: document.getElementById(\'e_globalSingleCoinSlPnl\').value !== \'\' ? parseFloat(document.getElementById(\'e_globalSingleCoinSlPnl\').value) : 0,',
        ...
        '            myGlobalSingleCoinSlPnl = document.getElementById(\'globalSingleCoinSlPnl\').value !== \'\' ? parseFloat(document.getElementById(\'globalSingleCoinSlPnl\').value) : 0;',
