...
app.get('/', (req, res) => {
    res.send([
        ...
        '                <button type="button" class="md-btn md-btn-primary" style="padding: 14px 32px; font-size:1rem;" onclick="showAuth(\'register\')">Start Free Trading</button>',
        '                <button type="button" class="md-btn md-btn-text" style="padding: 14px 32px; font-size:1rem; border:1px solid var(--border);" onclick="showAuth(\'login\')">Login</button>',
        '            </div>',
        '',
        '            <!-- Pricing Section -->',
        ...
        '                        <button type="button" class="md-btn md-btn-text" style="width:100%; border:1px solid var(--border);" onclick="showAuth(\'register\')">Register Now</button>',
        '                    </div>',
        ...
        '                </div>',
        '            </div>',
        '            <button type="button" class="md-btn md-btn-primary" style="width:100%; margin-top:24px; padding:14px;" id="auth-submit-btn" onclick="executeAuth()">Login</button>',
        '            <div style="text-align:center; margin-top:16px;">',
        '                <button type="button" class="md-btn md-btn-text" id="auth-toggle-btn" onclick="toggleAuthMode()">Create an Account</button>',
        '            </div>',
        ...
        '            document.getElementById(\'nav-actions\').innerHTML = \'<button type="button" class="md-btn md-btn-text" style="color:var(--text-main);" onclick="showAuth(\\\'login\\\')">Sign In</button><button type="button" class="md-btn md-btn-primary" onclick="showAuth(\\\'register\\\')">Start Free Trading</button>\';',
        '        }',
        '        function updateUIMode() {',
        '            const navActions = document.getElementById(\'nav-actions\');',
        '            let navHtml = \'\';',
        '            if (myUsername === \'webcoin8888\') {',
        '                navHtml += \'<button type="button" class="md-btn md-btn-text nav-btn active" id="btn-tab-editor" onclick="switchTab(\\\'editor\\\')"><span class="material-symbols-outlined">database</span> Template Editor</button>\';',
        '                navHtml += \'<button type="button" class="md-btn md-btn-text nav-btn" id="btn-tab-admin" onclick="switchTab(\\\'admin\\\')"><span class="material-symbols-outlined">manage_accounts</span> User Admin</button>\';',
        '                navHtml += \'<button type="button" class="md-btn md-btn-text nav-btn" id="btn-tab-main" onclick="switchTab(\\\'main\\\')"><span class="material-symbols-outlined">dashboard</span> Matrix Hub</button>\';',
        '                navHtml += \'<button type="button" class="md-btn md-btn-text nav-btn" id="btn-tab-offsets" onclick="switchTab(\\\'offsets\\\')"><span class="material-symbols-outlined">call_merge</span> Array V1</button>\';',
        '                navHtml += \'<button type="button" class="md-btn md-btn-text nav-btn" id="btn-tab-offsets2" onclick="switchTab(\\\'offsets2\\\')"><span class="material-symbols-outlined">alt_route</span> Array V2</button>\';',
        ...
        '                navHtml += badgeHtml;',
        '                navHtml += \'<button type="button" class="md-btn md-btn-text nav-btn active" id="btn-tab-main" onclick="switchTab(\\\'main\\\')"><span class="material-symbols-outlined">dashboard</span> Client Dashboard</button>\';',
        '                navHtml += \'<button type="button" class="md-btn md-btn-text" style="color:var(--text-muted); border-left:1px solid var(--border); border-radius:0; padding-left:16px; margin-left:8px;" onclick="logout()"><span class="material-symbols-outlined">logout</span> Disconnect</button>\';',
        '                navActions.innerHTML = navHtml;',
